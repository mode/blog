...
sorted_trips = sorted(trips, key=itemgetter(0,1))
test = sorted_trips[0:100]
...
write_to_csv("june_week_trim.csv",short)

The distinction between my user account and an organization account is unclear and poorly explained.
...
def simulate_game(team1,team2,spread,ou,team1_sd,team2_sd):
    team1_mean = (ou/2. - spread/2.)
    team2_mean = (ou/2. + spread/2.)
